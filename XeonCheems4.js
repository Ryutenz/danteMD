...
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「 ${global.botname} Script 」*\n\nGopay : 666\nDana : 666\nOvo : 666\nMBankingMobile : 666\nPulsa : 666\n\nBefore you want donate, please contacts My Owner : wa.me/6283819082780\n\nLink: ${global.websitex}\nGitHub: ${global.botscript}\n\nDont forget to donate `
let buttons = [
{buttonId: `menu`, buttonText: {displayText: 'Menu '}, type: 1}
]
let buttonMessage = {
...
mediaType:1,
mediaUrl: 'https://telegra.ph/file/a96fb94a36d924d99eb2f.jpg',
sourceUrl: "https://telegra.ph/file/a96fb94a36d924d99eb2f.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
╠${prefix}checkvote
╠${prefix}delvote
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube ","url": `${websitex}`}},{"urlButton": {"displayText": "Scriptl","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate ","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner ","id": 'owner'}}] )
break
case 'rpgmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
